...
int main() {
    ...
    for (int it = 1; it<=30;it++){
        ...
        total_makespan += tasks_start_end_times[task_priority_list[task_priority_list.size()-1]].second;
        avg_makespan = total_makespan/it;
        cout<<"it - "<<it<<endl;
